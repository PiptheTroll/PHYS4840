...
'''
load_file = '/d/users/iank/Downloads/MIST_v1.2_feh_m1.75_afe_p0.0_vvcrit0.4_HST_WFPC2.iso.cmd'
...
print(lb.distance_mod(8630))

fig, ax  = plt.subplots()
ax.scatter(color[quality_cut], magnitude[quality_cut], s=.1, color='black')
ax.scatter(cleaned_color, cleaned_magnitude + lb.distance_mod(8630), s=.1, color='green')
ax.invert_yaxis()
ax.set_xlim(-2, 5)
ax.set_ylim(25, 13.8)
plt.savefig('Shifted_Isochrone.png')
plt.show()